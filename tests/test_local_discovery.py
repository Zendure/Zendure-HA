...
class TestCreateDeviceMapping:
    ...
    def test_solarflow800pro2_mapped(self) -> None:
        """'solarflow800pro2' (lowercase) maps to SolarFlow800Pro."""
        from custom_components.zendure_ha.api import Api
        from custom_components.zendure_ha.devices.solarflow800 import SolarFlow800Pro

        assert Api.createdevice.get("solarflow800pro2") is SolarFlow800Pro
    ...
    def test_manager_lookup_is_case_insensitive(self) -> None:
        ...
        assert Api.createdevice.get("solarflow800pro2".lower().strip()) is SolarFlow800Pro
